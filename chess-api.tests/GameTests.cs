...
public class GameTests
{
    ...
    {
        var game = new Game();
        Assert.Throws<Exception>(() => game.ExecuteMove(36, 28));
    }
    ...
    {
        var game = new Game();
        Assert.Throws<Exception>(() => game.ExecuteMove(12, 28));
    }
    ...
    public void ExecuteMove_EdgeCase_PawnPromotion_WithNoPromotionPieceProvided()
    {
        ...
        var ex = Assert.Throws<Exception>(() => game.ExecuteMove(55, 63));
    ...
    {
        var game = new Game();
        game.ExecuteMove(52, 36); // e2 to e4
    ...
    public void ExecuteMove_EdgeCase_PawnDoubleMove_SetEnPassantSquare2()
    {
        ...
        game.ExecuteMove(10, 26); // c7 to c5
    ...
    public void ExecuteMove_EdgeCase_ResetEnPassantSquare()
    {
        ...
        game.ExecuteMove(58, 51); // bishop on c1 to d2
    ...
    public void ExecuteMove_EdgeCase_EnPassantCapture()
    {
        ...
        game.ExecuteMove(28, 19); // En passant capture e5 to d6
    ...
    public void ExecuteMove_EdgeCase_CastleRights_KingMoved()
    {
        ...
        game.ExecuteMove(60, 61); // White king e1 to f1
    ...
    {
        var game = new Game("r1bqkb1r/pppp1ppp/2n2n2/1B2p3/4P3/5N2/PPPP1PPP/RNBQK2R w KQkq - 0 1");
        game.ExecuteMove(63, 62); // White rook h1 to g1
    ...
    public void ExecuteMove_EdgeCase_CastleRights_QueenSideRookMoved()
    {
        ...
        game.ExecuteMove(0, 1); // Black rook a8 to b8
    ...
    public void ExecuteMove_EdgeCase_CastleRights_AttackingKingSidePath()
    {
        ...
        game.ExecuteMove(43, 34); // White bishop d3 to c4, attacking g8 square
    ...
    public void ExecuteMove_EdgeCase_CastleRights_CaptureOpponentRook()
    {
        ...
        game.ExecuteMove(56, 0); // White rook a1 captures black rook a8
    ...
    {
        var game = new Game();
        var ex = Assert.Throws<Exception>(() => game.ExecuteMove(52, 43));// Pawn on e2 cannot move diagonally to e5
    ...
    {
        var game = new Game();
        var ex = Assert.Throws<Exception>(() => game.ExecuteMove(63, 47)); // Rook on h1 cannot move to h3 because it is blocked by a friendly piece
        Assert.Equal("Attempted to execute an invalid move.", ex.Message);
    }
    ...
    {
        var game = new Game();
        var ex = Assert.Throws<Exception>(() => game.ExecuteMove(60, 52)); // King on e1 cannot move to e2 because it is occupied by a friendly piece
        Assert.Equal("Attempted to execute an invalid move.", ex.Message);
    }
    ...
    public void ExecuteMove_InvalidMove4()
    {
        ...
        var ex = Assert.Throws<Exception>(() => game.ExecuteMove(2, 9)); // Black bishop on c8 cannot move to b7 because it is occupied by a friendly piece
        Assert.Equal("Attempted to execute an invalid move.", ex.Message);
    }
    ...
    public void ExecuteMove_ExpectCorrectMoveCounts1()
    {
        var game = new Game();
        game.ExecuteMove(52, 36); // e2 to e4
        game.ExecuteMove(12, 28); // e7 to e5
        game.ExecuteMove(62, 45); // ng1 to f3
        game.ExecuteMove(1, 18); // nb8 to c6
        game.ExecuteMove(59, 52); // qd1 to h5
    ...
    public void ExecuteMove_ExpectCorrectMoveCounts2()
    {
        ...
        game.ExecuteMove(1, 18); // nb8 to c6
        game.ExecuteMove(59, 52); // qd1 to h5
        game.ExecuteMove(8, 24); // a7 to a5
