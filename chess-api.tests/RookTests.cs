namespace Chess
{
    public class RookTests
    {
        ...
        public void GetStandardMoves_Black8thRankOpen_Expect7Moves()
        {
            ...
            Assert.Contains(res, move => move.Index == 1 && move.IsCapture == true);
            ...
            Assert.Contains(res, move => move.Index == 5 && move.IsCapture == true);
        ...
        {
            var game = new Game();
            game.Board = new Board("rnbqkbnr/1p4pp/2pp1p2/2P1p3/1P1P4/R7/4PPPP/1NBQKBNR");
